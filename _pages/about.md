...
- Bingyi Liu, Jinbo He, Haiyong Shi, Enshu Wang\*, Weizhen Han\*, Jingxiang Hao, Peixi Wang and <u>Zhuangzhuang Zhang</u>. CHDP: Cooperative Hybrid Diffusion Policies for Reinforcement Learning in Parameterized Action Space[C]//Proceedings of the AAAI Conference on Artificial Intelligence. 2026, 40(28): 23640-23648. **AAAI 2026**
- Yizhou Wang, Libing Wu\*, <u>Zhuangzhuang Zhang</u>\*, Lijuan Huo, Jiaqi Feng, Jing Wang and Jiong Jin. Transferable Adversarial Attacks on 3-D Point Cloud Semantic Segmentation via Diffusion Models in Autonomous Driving[J]. IEEE Transactions on Consumer Electronics, 2026, early access. **TCE 2026**
- Yu Zhao, Libing Wu\*, Jing Wang, Weihao Li, Jiong Jin, <u>Zhuangzhuang Zhang</u> and Yizhou Wang. LDSAV: Lightweight and Dynamically Scalable Authentication Key Agreement for Vehicle-Cloud Collaboration[J]. IEEE Transactions on Vehicular Technology, 2026, 75(8): 17710-17724. **TVT 2026**
- Taiyu Bao, Libing Wu\*, <u>Zhuangzhuang Zhang</u>\*, Lijuan Huo, Jing Qiu and Qin Liu. Triggering Phantom Obstacles: Black-Box Physical Adversarial Attacks Against MDE for Autonomous Vehicles[J]. IEEE Transactions on Vehicular Technology, 2026, early access. **TVT 2026**
- Rui Zhang, Hongyu Ren, Di Wu\*, <u>Zhuangzhuang Zhang</u> and Xiaojun Lu. Secure and Resilient Cluster Head Election for UAV-assisted IoV: A Synergistic Approach with Trust Fusion and Dynamic Fitness[J]. IEEE Transactions on Vehicular Technology, 2026, early access. **TVT 2026**
...
- <u>Zhuangzhuang Zhang</u>, Libing Wu*, Chuanguo Ma, Jianxin Li, Jing Wang, Qian Wang and Shui Yu. LSFL: A Lightweight and Secure Federated Learning Scheme for Edge Computing[J]. IEEE Transactions on Information Forensics and Security, 2023. **TIFS 2023** 🏆 **(ESI Highly Cited Paper)**
...
- Program Committee Member: WASA (2024, 2025), HPCC (2025), TrustCom (2025).
